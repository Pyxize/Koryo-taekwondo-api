...
<div class="container mx-auto h-full mt-6">
    @if(session('success'))
    ...
    @if($errors->any())
            <div id="toast-warning" class="flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow mb-6" role="alert">
